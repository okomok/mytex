...
\myinn{preview}{math}{
    \strdpicturein{gathered}{
        \strdmid{\strdorigin}{U} \strdsidelabel{$(U)+(0,0.05)$}{}{Z}
        \strdroadlshift{U}{U0}
...
\myinn{preview}{math}{
    \strdpicturein{gathered}{
        \strdmid{\strdorigin}{Z'} \strdsidelabel{$(Z')+(0,0.08)$}{}{Z}
        \strdleft{Z'}{ZB} \strdsidelabel{ZB}{Y}{}
        \strdright{Z'}{X'} \strdsidelabel{X'}{}{X}
    ...
    \strdpicturein{gathered}{
        ...
        \strdcelllabel{U End}{\epsilon}
        \strdleft{U}{Z}
        \strdroad{right}{U}{ZZ'} % \strdroadlabel{ZZ' Corner}{}{Z}
        \strdroadrshift{ZZ'}{ZZ'S}
        \strdmid{ZZ'S}{Z'}
        \strdleft{Z'}{ZB}
        \strdright{Z'}{X'}
        \strdmid{X'}{X'2} \strdsidelabel{X'2}{X}{}
        \strdcelllabel{Z' End}{h}
        \strdscale{1.5}{2}{\strdbij{ZZ'S}{Box}}
        \strdyscale{3}{\strdmid{Z}{Z2}} \strdsidelabel{$(Z2)+(0,-0.5)$}{}{Y}
    } 
}
