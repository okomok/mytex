...
$\to$
\List{\Unlist{\List{1,2,3}}}\UnlistImpl{}
$\to$
\Singleton{\Unlist{\List{1,2,3}}}\UnlistImpl{}
$\to$
\Cons{\Unlist{\List{1,2,3}}}\Nil\UnlistImpl{}
$\to$
\UnlistImpl{\Unlist{\List{1,2,3}}}\Nil
$\to$
\Unlist{\List{1,2,3}}\Foldr\PrependComma{}\Nil
$\to$
\List{1,2,3}\UnlistImpl{}\Foldr\PrependComma{}\Nil
$\to$
\Cons{1}{\Cons{2}{\Cons{3}\Nil}}\UnlistImpl{}\Foldr\PrependComma{}\Nil
$\to$
\UnlistImpl{1}{\Cons{2}{\Cons{3}\Nil}}\Foldr\PrependComma{}\Nil
$\to$
